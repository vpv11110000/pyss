...
class Advance(Block):
    ...
    Args:
        ...
        meanTime - задаёт среднее время обслуживания (число или функция f()). Если задан список или кортеж, то среднее значение будет последовательно выбираться из списка. По окончании списка будет возвращаться 0.
