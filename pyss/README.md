...
Описание
=====
На каждый Блок можно сослаться с помощью Label

test.py

        # прямая адресация
        # ATTRNAME1 пример: "FACILITY.fac_1.STATE"
        # косвенная адресация
        # ATTRNAME1 пример: "TRANSACT.par_2.AS_LABEL.STATE"
        # AS_LABEL - интерпретировать TRANSACT.par_2 как метку объекта
        # т.е. Если в TRANSACT.par_2 записано FACILITY.fac_1,
        # то TRANSACT.par_2.AS_LABEL.STATE будет расценено как FACILITY.fac_1.STATE

sda - системный числовой аттрибут

TODO
=====
1. 2016-12-29 Table handle transact
